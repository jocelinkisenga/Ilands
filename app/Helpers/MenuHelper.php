...
class MenuHelper
{
    ...
    public static function getMainNavItems()
    {
        return [
            ...
            [
                'icon' => 'book', // Vous pouvez remplacer par une icône document si nécessaire
                'name' => 'My documents',
                'roles' => ['client'],
                'path' => '/documents',
            ...
            [
                ...
                'roles' => ['client'],
                'path' => '/tax-profile',
                'route_name' => 'tax-profile', // Protégé par middleware 'subscribed'
            ],
            [
                'icon' => 'user-profile',
                'name' => 'Mon Profil',
    ...
    public static function getAdminNavItems()
    {
        return [
            ...
            [
                ...
                'subItems' => [
                    ['name' => 'Tous les contenus', 'path' => '/admin/content', 'route_name' => 'content.index'],
                    ['name' => 'Ajouter un contenu', 'path' => '/admin/content/create', 'route_name' => 'content.create'],
                ],
            ],
        ];
    }
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'book'           => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 6.00002L4 3.00002V17L12 20M12 6.00002L20 3.00002V17L12 20M12 6.00002V20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
