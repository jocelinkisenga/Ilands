...
@php
    $currentYear = date('Y');
@endphp
  <div class="relative bg-gray-50 dark:bg-black flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
      {{-- common grid shape --}}
      ...
      <p class="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {{ $currentYear }} - Iland solutions
      </p>
  </div>
@endsection
