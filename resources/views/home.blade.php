    ...
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <template x-for="plan in plans" :key="plan.name">
                <div class="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 hover:border-emerald-400/40 transition">
                    <h3 class="text-xl font-semibold mb-4" x-text="plan.name"></h3>
                    <p class="text-3xl font-bold mb-6">
                        <span x-text="currencySymbol"></span>
                        <span x-text="plan.price"></span>
                    </p>
                    <p class="text-white/70 mb-8" x-text="plan.desc"></p>
                    <button @click="openAssessment=true"
                            class="w-full bg-emerald-500 hover:bg-emerald-600 text-black py-3 rounded-xl transition">
                        Choose Plan
                    </button>
                </div>
            </template>
