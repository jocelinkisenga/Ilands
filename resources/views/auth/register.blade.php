...
<div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
 <div class="flex min-h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
  ...
  <div class="flex w-full flex-1 flex-col lg:w-1/2">
    ...
    <div>
     ...
     <form action="{{route('register')}}" method="POST">
      ...
      <div class="space-y-5">
       <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div class="sm:col-span-1">
         <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
          First Name<span class="text-error-500">* @error('name')
           {{$message}}
           @enderror</span>
         </label>
       ...
       <div class="sm:col-span-1">
        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
         Last Name<span class="text-error-500">* @error('name')
          {{$message}}
          @enderror</span>
        </label>
   ...
   <div>
    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
     Password confirm<span class="text-error-500">*
      @error('password')
      {{$message}}
      @enderror
    ...
    <div x-data="{ showPassword: false }" class="relative">
     <input :type="showPassword ? 'text' : 'password'" placeholder="confirm your password" name="password_confirmation"
     class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
    <span @click="showPassword = !showPassword"
     class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
     <svg x-show="!showPassword" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="mt-5 bg-white dark:bg-gray-900">
