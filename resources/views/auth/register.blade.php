<x-auth-layout>
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-slate-500 mt-1">
            Start your journey with ILANDS AI workspace
        </p>
