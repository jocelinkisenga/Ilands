<nav x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 w-full bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-slate-200 dark:border-white/10 transition-colors duration-300">
        ...
        <div class="flex justify-between h-20">
            ...
            <div class="hidden lg:flex items-center space-x-6">
                ...
                <button @click.prevent="$store.theme.toggle()" class="ml-4 p-2 rounded-lg bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-white transition">
                    <span class="dark:hidden text-base">
                    ...
                    <span class="hidden dark:inline text-base">
    ...
    <div x-show="mobileMenuOpen" 
         ...
         style="display: none;">
               <a href="/pricing" class="block text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white py-3 border-b border-slate-100 dark:border-white/5">Pricing</a>
               <a href="/blog" class="block text-xs text-black font-bold uppercase tracking-widest hover:text-green-600 dark:text-green-500  dark:hover:text-green-500 transition">{{__('blog')}}</a>
