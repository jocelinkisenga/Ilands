        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-green-500/10 rounded-2xl p-8">
                    ...
                    <a href="{{route('checkout', ['plan' => "price_1T6e0nIr46jOY2dW34G50nGB"])}}" class="mt-10 block text-center py-3 border border-green-500 rounded-lg hover:bg-green-600/10 transition">
                        Start free
                    </a>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-600/20 to-black backdrop-blur-xl border border-green-500/30 rounded-2xl p-10 shadow-2xl scale-105">
                    ...
                    <a href="{{route('checkout', ['plan' => "price_1T7jXLIr46jOY2dWdjhaShLd"])}}" class="mt-10 block text-center py-3 bg-green-600 hover:bg-green-500 rounded-lg font-semibold transition">
                        Book Strategy Call
                    </a>
                </div>
